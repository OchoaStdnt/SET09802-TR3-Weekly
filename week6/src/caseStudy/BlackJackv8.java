 ...
 * 
 * The aim of version 8:
 * Version 7 produced a working program that was able to play the game of Black Jack. 
 * While we were developing the program it was convenient to see the value of the 
 * computers cards, however to play the game properly the computer should only 
 * reveal one of its cards and the player should not be aware of the computers total 
 * until the player has finished selecting their own cards.
